import svgPaths from "./svg-r011tmicvy";
...
function ImgRisorsa() {
  return (
    <div className="absolute h-[810px] left-1/2 top-[270px] translate-x-[-50%] w-[900px]" data-name="img-risorsa">
      <img alt="" className="absolute inset-0 max-w-none object-contain pointer-events-none size-full" src={imgImgRisorsa} />
    </div>
  );
}
...
export default function Risorsa() {
  return (
    <div className="bg-[#cce6df] relative size-full" data-name="risorsa">
      <ComposizioniSfondo />
      <div className="absolute flex flex-col font-['Rowan_Variable:Medium',sans-serif] font-medium h-[120px] justify-center leading-[0] left-1/2 text-[#003326] text-[56px] text-center top-[160px] translate-x-[-50%] translate-y-[-50%] w-[900px]">
        <p className="css-4hzbpn leading-[1.25]">Inserisci qui il titolo del post</p>
      </div>
      <LogoMlolPortale />
      <ImgRisorsa />
    </div>
