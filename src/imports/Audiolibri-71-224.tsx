import svgPaths from "./svg-ez90mzq2f9";
...
function Audiolibri1() {
  return (
    <div className="absolute contents left-[69px] top-[365px]" data-name="audiolibri">
      <div className="absolute left-[69px] size-[621px] top-[365px]" data-name="immagine 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImmagine1} />
      </div>
      <div className="absolute left-[710px] size-[301px] top-[365px]" data-name="immagine 2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImmagine1} />
      </div>
      <div className="absolute left-[710px] size-[301px] top-[685px]" data-name="immagine 3">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgImmagine1} />
      </div>
    </div>
  );
...
export default function Audiolibri() {
  return (
    <div className="bg-[#cce6df] relative size-full" data-name="audiolibri">
      <ComposizioniSfondo />
      <LogoMlolPortale />
