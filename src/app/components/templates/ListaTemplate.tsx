...
export function ListaTemplate({
  ...
  return (
    <div className="relative size-full" data-name="lista" style={{ backgroundColor: colors.bg, width: '1080px', height: '1350px' }}>
      ...
      {/* Lista Title */}
      <p className="absolute left-1/2 text-center top-[calc(50%-563px)] translate-x-[-50%] w-[900px]" style={{
      ...
      {/* LISTA Label */}
      <p className="absolute left-1/2 text-center top-[calc(50%-635px)] translate-x-[-50%] uppercase w-[900px]" style={{
        fontFamily: 'Switzer, sans-serif',
        fontWeight: 700,
        fontSize: '48px',
        lineHeight: 'normal',
      ...
      <div className="absolute contents left-[134px] top-[306px]" data-name="griglia">
        <div 
          className="absolute h-[338px] left-[686px] top-[673.28px] w-[260px]" 
          data-name="img-lista3"
          style={{
        ...
        />
        <div 
          className="absolute h-[338px] left-[686px] top-[306.28px] w-[260px]" 
          data-name="img-lista2"
          style={{
        ...
        />
        <div 
          className="absolute h-[711px] left-[134px] top-[306px] w-[523px]" 
          data-name="img-lista1"
          style={{
