...
import imgImgLista3 from "figma:asset/b6cd8dbea5911d2204d79588264b4ddb2e89924f.png";
...
interface ListaEbookTemplateProps {
...
export function ListaEbookTemplate({
  colorScheme,
  composizione,
  logoPortale,
  nomePortale,
  ...
  listaTitle,
  curator,
}: ListaEbookTemplateProps) {
  const colors = colorSchemes[colorScheme];

  return (
    <div className="relative size-full" data-name="lista-ebook" style={{ backgroundColor: colors.bg, width: '1080px', height: '1350px' }}>
      {/* Background */}
      {composizione !== 'none' && (
